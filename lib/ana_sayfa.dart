...
class _AnaSayfaState extends State<AnaSayfa> {
  ...
  void _jsonCozumle() async {
    String jsonString = await rootBundle.loadString("assets/iller_ilceler.json"); // json verilerini string formatında aldık elimize. şimdi map'e çevireceğiz
    ...
    for(String plakaKodu in illerMap.keys){
      ...
      Il il = Il(isim: ilIsmi, plakaKodu: plakaKodu, ilceler: tumIlceler); // Il nesnesini bir değişkene atıyoruz.
      iller.add(il);
    }
    setState(() {
